      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Parixa is an online platform for students to practice MCQs and prepare for exams. Our mission is to make
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/subjects" className="text-gray-600 hover:text-purple-600 transition-colors">
                  Subjects
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-sm text-center">
            &copy; {new Date().getFullYear()} Parixa. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
